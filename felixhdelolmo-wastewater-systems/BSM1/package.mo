package BSM1 "Component models for the Benchmark Simulation Model No.1"
  ...
  model BSM1_ClosedLoop_A
    ...
    Modelica.Blocks.Continuous.PI PI1(k = 0.833, T = 0.042) annotation(
      Placement(visible = true, transformation(origin = {92.3274, 85.516}, extent = {{-8.19616, -8.19616}, {8.19616, 8.19616}}, rotation = 0)));
    ...
    Modelica.Blocks.Sources.Constant constant3 annotation(
    ...
    Modelica.Blocks.Continuous.PI PI3(T = 0.001) annotation(
      Placement(visible = true, transformation(origin = {92, 58}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  equation
    connect(PI3.y, blower3.u) annotation(
    ...
    connect(PI1.y, feedback3.u1) annotation(
      Line(points = {{101, 86}, {118, 86}, {118, 70}, {56, 70}, {56, 58}, {62, 58}}, color = {0, 0, 127}));
    connect(feedback2.y, PI1.u) annotation(
      Line(points = {{46, 85}, {52.9395, 85}, {52.9395, 85.1601}, {82, 85.1601}, {82, 86}}));
    ...
    connect(constant3.y, RecyclePump.u) annotation(
  ...
  model BSM1_ClosedLoop_B1
    ...
    Modelica.Blocks.Math.Feedback feedback2 annotation(
      Placement(visible = true, transformation(origin = {70.9751, 84.6192}, extent = {{-7.45106, -7.45106}, {7.45106, 7.45106}}, rotation = 0)));
    WasteWater.ASM1.sensor_O2 sensor_o21 annotation(
      Placement(visible = true, transformation(origin = {35.2313, 23.1317}, extent = {{-8.19616, -8.19616}, {8.19616, 8.19616}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI PI1(k = 0.833, T = 0.042) annotation(
      Placement(visible = true, transformation(origin = {92.3274, 85.516}, extent = {{-8.19616, -8.19616}, {8.19616, 8.19616}}, rotation = 0)));
    ...
    Modelica.Blocks.Continuous.PI PI3(T = 0.001) annotation(
      Placement(visible = true, transformation(origin = {92, 58}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI PI2(T = 0.001) annotation(
  ...
  equation
    ...
    connect(PI2.y, feedback2.u1) annotation(
      Line(points = {{48, 88}, {64, 88}, {64, 84}, {66, 84}}, color = {0, 0, 127}));
    connect(sensor_o21.So, feedback2.u2) annotation(
      Line(points = {{43.0486, 23.7874}, {44.484, 23.7874}, {44.484, 36.2989}, {46.6192, 36.2989}, {46.6192, 79}, {71, 79}}));
    connect(feedback2.y, PI1.u) annotation(
      Line(points = {{78, 85}, {76.9395, 85}, {76.9395, 85.1601}, {82, 85.1601}, {82, 86}}));
    connect(PI3.y, blower3.u) annotation(
      Line(points = {{100, 58}, {118, 58}, {118, -38}, {32, -38}, {32, -38}, {32, -38}}, color = {0, 0, 127}));
    connect(feedback3.y, PI3.u) annotation(
      Line(points = {{76, 58}, {82, 58}, {82, 58}, {82, 58}}, color = {0, 0, 127}));
    ...
    connect(divider.Out2, Settler.Feed) annotation(
      Line(points = {{39.0747, 4.51246}, {45.5516, 4.51246}, {45.5516, 28.0807}, {60.2777, 28.0807}}));
    annotation(
      Diagram(graphics = {Text(origin = {-171, 78}, extent = {{-57, 20}, {39, -20}}, textString = "B1: Ammonium Based control: feedback")}, coordinateSystem(initialScale = 0.1)));
  ...
  equation
    connect(add1.u1, PI2.y) annotation(
      Line(points = {{59, 90}, {48, 90}, {48, 88}}, color = {0, 0, 127}));
    connect(add1.u2, aDsensor_NH.Snh) annotation(
      Line(points = {{59, 82}, {54, 82}, {54, 74}, {-4, 74}, {-4, 52}, {-18, 52}, {-18, 50}}, color = {0, 0, 127}));
  ...
  model BSM1_ClosedLoop_D
    ...
    Modelica.Blocks.Math.Feedback feedback3 annotation(
      Placement(visible = true, transformation(origin = {68, 58}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI PI3(T = 0.01, k = 0.001) annotation(
      Placement(visible = true, transformation(origin = {92, 58}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI PI2(T = 0.001) annotation(
      Placement(visible = true, transformation(origin = {40, 88}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
    Modelica.Blocks.Math.Feedback feedback1 annotation(
    ...
    Modelica.Blocks.Sources.Constant const_timers(k = 0.15) annotation(
  ...
  equation
    ...
    connect(switchBlower0.u1, constant2.y) annotation(
    ...
    connect(PI3.y, greaterEqual1.u1) annotation(
      Line(points = {{100, 58}, {118, 58}, {118, -4}, {148, -4}}, color = {0, 0, 127}));
    connect(PI3.y, lessEqual_1.u1) annotation(
  ...
  model BSM1_kk
    ...
    Modelica.Blocks.Continuous.PI PI3(T = 0.001) annotation(
      Placement(visible = true, transformation(origin = {92, 58}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  BSM1.Modules.ADsensor_kk aDsensor_kk annotation(
      Placement(visible = true, transformation(origin = {16, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(aDsensor_kk.In, blower3.AirOut) annotation(
      Line(points = {{25, -22}, {30.5, -22}, {30.5, -27}, {22, -27}}));
    connect(tank5.AirIn, aDsensor_kk.Out) annotation(
      Line(points = {{2, -9}, {2, -22}, {7, -22}}));
    connect(feedback3.u2, aDsensor_kk.Q_air) annotation(
      Line(points = {{68, 52}, {50, 52}, {50, -26}, {16, -26}, {16, -31}}, color = {0, 0, 127}));
    connect(PI3.y, blower3.u) annotation(
      Line(points = {{100, 58}, {118, 58}, {118, -38}, {32, -38}, {32, -38}, {32, -38}}, color = {0, 0, 127}));
    connect(feedback3.y, PI3.u) annotation(
      Line(points = {{76, 58}, {82, 58}, {82, 58}, {82, 58}}, color = {0, 0, 127}));
